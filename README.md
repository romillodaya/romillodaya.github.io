# Romil's personal notebook

A minimal personal website for essays, notes, projects, trips, and everyday stories. Built with React and Next.js, with a Vinext preview and GitHub Pages export.
